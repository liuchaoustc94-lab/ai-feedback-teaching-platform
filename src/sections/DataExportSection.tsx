...
export default function DataExportSection({ onExport }: { onExport?: () => void }) {
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          ...
          <button onClick={onExport} className="inline-flex items-center gap-2 bg-[#111] text-white px-6 py-3 rounded-lg text-sm font-medium hover:bg-[#333] transition-colors duration-300 self-start md:self-auto">
            <Download size={16} />
            导出 Excel
          </button>
        </div>
          ...
          <div className="data-row flex items-start gap-4 p-6 bg-[#f7f7f5] rounded-xl">
            ...
            <div>
              ...
              <p className="text-xs text-[#666] leading-relaxed">
                账号资料和训练记录按权限保存。视频画面不上传服务器，姿态指标与报告仅在授权后同步。
              </p>
            </div>
          </div>
